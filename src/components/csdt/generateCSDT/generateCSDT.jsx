    ...
    return (
      <Grid
        ...
        <Grid item xs={10} className={classes.header}>
          <Typography variant="h2" className={ classes.title }>Generate {generatedDenom}</Typography>
        </Grid>
        <Grid item xs={2} align="right">
          <CloseIcon onClick={onClose} className={ classes.closeButton }/>
        </Grid>
        <Grid item xs={12} className={ classes.sepperate }>
          <Typography variant="body1">How much {generatedDenom} would you like to generate?</Typography>
          <TextField
        ...
        <Grid item xs={12} className={ classes.sepperate }>
          ...
          <Typography variant="h3" className={ classes.infoValue }>{ currentRatios.maxGenerated + ' ' + generatedDenom }</Typography>
...
export default withRouter(connect(mapStateToProps)(withStyles(styles)(GenerateCSDT)))
